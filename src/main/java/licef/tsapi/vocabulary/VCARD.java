...
/**
 * Vocabulary definitions from vcard.rdf 
 * @author Auto-generated by schemagen on 22 nov. 2013 09:47 
 */
public class VCARD extends VocabularyModel {
    ...
    public static final String VERSION_INFO = "Draft";
    ...
    /** <p>This object property has been deprecated. Use the organization-name data property.</p> */
    ...
    /** <p>The vCard class is deprecated and equivalent to the new Kind class, which 
     *  is the parent for the four explicit types of vCards (Individual, Organization, 
     *  Location, Group)</p>
     */
